...
class Loading extends React.Component<LoadingProps, LoadingState> {
  ...
  onResize() {
    this.setState({
      ...
      backFrom: `0 0 0 0 0 ${window.innerHeight} 0 ${window.innerHeight}`,
      backTo: `0 0 ${window.innerWidth} 0 ${window.innerWidth} ${window.innerHeight} 0 ${window.innerHeight}`,
    });
  }
        ...
        >
          <svg width={this.state.width} height={this.state.height} 
            ...
            <polygon
              ...
              points={
                this.state.visible
                ? `0 0 ${this.state.width} 0 ${this.state.width} ${this.state.height} 0 ${this.state.height}`
                : `0 0 0 0 0 ${this.state.height} 0 ${this.state.height}`
              }
            />
          </svg>
